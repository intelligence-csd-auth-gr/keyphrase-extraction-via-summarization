...
py.plot(fig, filename='..//schemas//summary_preprocess_barplot_keyphrase_counting.html')
...
title:  30088
abstract:  62226
either in title or abstract:  66893
in title, NOT in abstract:  4667
total keyphrases:  105459
count of keywords in title:  0.28530518969457325
count of keywords in abstract:  0.5900492134383979
count of keywords that are either in title or abstract:  0.6343033785641813
count of keywords that are in title and NOT in abstract:  0.04425416512578348
'''
...
labels = ['KPs in title', 'KPs in summary', 'KPs in title & \n summary', 'KPs in title & \n not in summary']
...
plt.title("Keyphrase coverage percentage of title, summary and combinations \n Total count of gold keyphrases: {}".format(total_keywords), pad=10)
...
# histogram
plt.hist(doc_length, color='blue', edgecolor='black',
         bins=size)
# Add labels
