...
file = '..\\semeval_2010.json'  # TEST data to evaluate the final model


# Define the file paths and names to save TEST data to evaluate the final model
x_filename = '..\\..\\preprocessed_data\\first_paragraphs_fulltext\\x_SEMEVAL_FIRST_PARAGRAPHS_FULLTEXT_TEST_data_preprocessed'
y_filename = '..\\..\\preprocessed_data\\first_paragraphs_fulltext\\y_SEMEVAL_FIRST_PARAGRAPHS_FULLTEXT_TEST_data_preprocessed'


# Define the file paths and names to save preprocessed TEXT of ABSTRACT and KEYPHRASES
x_text_filename = '..\\..\\preprocessed_data\\first_paragraphs_fulltext\\x_SEMEVAL_FIRST_PARAGRAPHS_FULLTEXT_preprocessed_TEXT'  # save preprocessed text for TEST data
y_text_filename = '..\\..\\preprocessed_data\\first_paragraphs_fulltext\\y_SEMEVAL_FIRST_PARAGRAPHS_FULLTEXT_preprocessed_TEXT'  # save preprocessed keyphrases for TEST data


# Define the number of lines to read
batch_size = 64  # 1024  # 10000
# max length of sequences - used for padding (count when the text is tokenized)
max_len = 400  # 220  # Used to match the data dimensions for both TRAIN and TEST data
...
print('BEFORE contractions data[keywords]', data['keyword'])
...
print('AFTER contractions data[keywords]', data['keyword'])
...
'''
3 first paragraphs (220)
KP count:  6264 
KP WORDS count:  10546 
NON-KP count:  126686
X SHAPE (732, 212)

3 first paragraphs (400)
KP count:  10301 
KP WORDS count:  16738 
NON-KP count:  238298
X SHAPE (732, 387)
'''
