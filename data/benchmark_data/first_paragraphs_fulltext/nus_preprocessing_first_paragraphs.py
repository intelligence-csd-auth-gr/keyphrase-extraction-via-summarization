...
x_filename = '..\\..\\preprocessed_data\\first_paragraphs_fulltext\\x_NUS_FIRST_PARAGRAPHS_FULLTEXT_TEST_data_preprocessed'
y_filename = '..\\..\\preprocessed_data\\first_paragraphs_fulltext\\y_NUS_FIRST_PARAGRAPHS_FULLTEXT_TEST_data_preprocessed'


# Define the file paths and names to save preprocessed TEXT of ABSTRACT and KEYPHRASES
x_text_filename = '..\\..\\preprocessed_data\\first_paragraphs_fulltext\\x_NUS_FIRST_PARAGRAPHS_FULLTEXT_preprocessed_TEXT'  # save preprocessed text for TEST data
y_text_filename = '..\\..\\preprocessed_data\\first_paragraphs_fulltext\\y_NUS_FIRST_PARAGRAPHS_FULLTEXT_preprocessed_TEXT'  # save preprocessed keyphrases for TEST data
