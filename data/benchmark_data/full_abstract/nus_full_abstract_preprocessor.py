...
X = []
for index, abstract in enumerate(data['abstract']):
    text_vectors = []  # saves GloVe vectors for one title + abstract
...
for index, abstract in enumerate(data['abstract']):
    text_word_labels = []  # keep the labels of the all the words contained in a single title and abstract
...
max_len = 500  # Used to match the data dimensions for both TRAIN and TEST data
